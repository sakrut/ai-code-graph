...
public class CognitiveComplexityTests
{
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true) { } } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true) { } else { } } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true) { } else if (false) { } else { } } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired(@"class C { void M() { if (true) { if (true) { } } } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired(@"
class C { void M() {
    if (true) {         // +1 (nesting 0)
        for (;;) {      // +2 (nesting 1)
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { for (int i = 0; i < 10; i++) { } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { while (true) { } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { do { } while (true); } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired(@"class C { void M() { switch (0) { case 0: break; } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired(@"class C { void M() { try { } catch { } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true && false) { } } }");
        // if: +1, &&: +1 = 2
        Assert.Equal(2, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true && false && true) { } } }");
        // if: +1, && sequence: +1 = 2
        Assert.Equal(2, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { int M() { return true ? 1 : 0; } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired(@"class C { void M() { goto end; end: return; } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
...
class C { void M() {
    ...
    {
        var body1 = TestHelpers.GetMethodBodyRequired("class C { void M() { if (true) { } } }");
        var body2 = TestHelpers.GetMethodBodyRequired("class C { void M() { } }");
    ...
    {
        var body = TestHelpers.GetMethodBodyRequired("class C { object M(object? x) { return x ?? new object(); } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
}
...
public class LinesOfCodeTests
{
    ...
    {
        var body = TestHelpers.GetMethodBody("class C { void M() { } }");
    ...
    {
        var body = TestHelpers.GetMethodBody(@"
class C { void M() {
    int a = 1;
    int b = 2;
    int c = a + b;
...
public class MaxNestingDepthTests
{
    ...
    {
        var body = TestHelpers.GetMethodBody("class C { void M() { int a = 1; } }");
        Assert.Equal(0, _calc.Calculate(body));
    }
    ...
    public void SingleIf_ReturnsOne()
    {
        var body = TestHelpers.GetMethodBody("class C { void M() { if (true) { } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
    ...
    {
        var body = TestHelpers.GetMethodBody("class C { void M() { if (true) { if (true) { } } } }");
        Assert.Equal(2, _calc.Calculate(body));
    }
...
class C { void M() {
    ...
    {
        var body = TestHelpers.GetMethodBody("class C { void M() { try { } catch { } } }");
        Assert.Equal(1, _calc.Calculate(body));
    }
...
namespace MyApp
{
    public class Service
    {
        ...
        var metrics = engine.ComputeMetrics(TestHelpers.CreateWorkspace(source));
